...
export const socialRightPanelFeeds = [
  { id: 1, name: 'Yuri Manga', icon: '🔵', followed: false },
  { id: 2, name: 'Lolicon', icon: '🟣', followed: false },
...
export const socialProfileUser = {
  name: 'micromimo',
  handle: '@micromimo.prysm',
  avatar: '/avater.jpg',
  header: '',
...
export const socialProfilePosts = [
  {
    id: 1,
    user: 'micromimo',
    handle: '@micromimo.prysm',
  ...
  },
  {
    ...
    avatar: '/avater.jpg',
    time: '3 小時前',
    content: '#百合 #さよならの朝に約束の花をかざろう\n\n双向奔赴的爱情真的很美好 💐',
    image: 'https://picsum.photos/seed/lily/800/450',
    likes: 8,
    comments: 2,
    shares: 1,
    reposts: 0,
  ...
  },
  {
    ...
    avatar: '/avater.jpg',
    time: '昨天',
    content: '#Rust #编程语言\n\n正在学习 Rust，所有权和借用机制真的很需要时间消化，但编译器提示真的很友好！\n\n```rust\nfn main() {\n    let s1 = String::from("hello");\n    let s2 = s1; // 移动所有权\n    println!("{}", s2);\n}\n```',
...
export const socialSettingsValues = {
  email: 'micromimo@proton.me',
  location: '🇮🇸 · Reykjavíka',
  link: '未设置',
  theme: '浅色模式',
};