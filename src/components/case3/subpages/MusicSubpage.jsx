  ...
  return (
    <div className="h-full flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-heading">Music Player</h2>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 min-h-0">
        <div className="lg:col-span-2 flex flex-col gap-4">
          <div className="liquid-glass rounded-2xl p-8 flex flex-col items-center justify-center">
            ...
            <p className="text-body mb-1">{currentSong.artist}</p>
            <p className="text-sm text-muted mb-8">{currentSong.album}</p>
            ...
            <div className="flex items-center gap-6 mt-8">
              ...
              <div className="w-32">
                <input
                  ...
                  style={{
                    background: `linear-gradient(to right, #ec4899 0%, #FEBEBE ${isMuted ? 0 : volume}%, rgba(255,255,255,0.3) ${isMuted ? 0 : volume}%, rgba(255,255,255,0.3) 100%)`
                  }}
                />
              </div>
              <button 
        ...
        {showLyrics ? (
          <div className="flex flex-col gap-3 overflow-auto liquid-glass rounded-2xl p-6">
            <h4 className="text-sm font-medium text-body mb-4 text-center">
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="space-y-4 text-center">
                ...
                {!currentSong.lyrics && (
                  <div className="text-muted text-sm">暂无歌词</div>
                )}
              </div>
            </div>
          </div>
            ...
            {songs.map((song, index) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4 className={`text-sm font-medium truncate ${index === currentSongIndex ? 'text-pink-700' : 'text-heading'}`}>
                    {song.title}
                  </h4>
