        ...
        <div className="h-full overflow-y-auto p-5 flex flex-col gap-5 hide-scrollbar">
          ...
          <Section title="连接设置" icon={<Wifi className="w-4 h-4" />}>
            <div className="flex flex-col gap-3">
              <label className="text-xs font-medium text-gray-500">服务地址</label>
              <input
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-gray-600">编解码格式</span>
                <div className="flex gap-1">
                  {[
                    ...
                    <button
                      ...
                      className="flex-1 min-w-[44px] py-1.5 text-xs rounded-lg transition-all text-gray-700 shadow-md"
                      style={
                        codecFormat === v
                          ? {
            ...
            <div className="space-y-4">
              <SettingRow label="画面缩放">
                <div className="flex items-center gap-2 w-full min-w-0">
                  ...
                  />
                  <span className="text-xs font-mono text-gray-600 w-10 text-right flex-shrink-0">{displayScale.toFixed(1)}x</span>
                </div>
              </SettingRow>

              <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-600">颜色校正</span>
                  <Toggle checked={colorCorrection} onChange={(v) => handleSettingChange('colorCorrection', v)} />
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-600">FPS 叠加</span>
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  className="py-2 rounded-xl text-xs text-gray-700 flex items-center justify-center gap-2 transition-all sidebar-white"
                  title="系统全屏"
                >
                ...
                <button
                  ...
                  className="py-2 rounded-xl text-xs text-gray-600 flex items-center justify-center gap-2 transition-all sidebar-white"
                >
