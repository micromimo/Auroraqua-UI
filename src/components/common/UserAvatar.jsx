            ...
            <div className="liquid-glass rounded-2xl p-4 shadow-2xl border border-white/30">
              <div className="flex items-center gap-3 mb-4 pb-4 border-b border-white/20">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-bold text-slate-700 truncate">@micromimo</div>
                  <div className="text-xs text-slate-500 truncate">micromimo@proton.me</div>
                </div>
              </div>
              ...
              <div className="space-y-1">
                {menuItems.map((item) => (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-600 hover:bg-white/30 hover:text-slate-800 transition-all duration-200"
                  >
