  ...
  return (
    <div className="min-h-screen p-8" style={{
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="glass rounded-2xl p-6 mb-6">
          <h2 className="text-lg font-semibold text-heading mb-4">功能特性</h2>
          <ul className="space-y-3">
            {[
              ...
              <li key={index} className="flex items-center gap-3 text-sm text-body">
        ...
        <div className="glass rounded-2xl p-6">
          <h2 className="text-lg font-semibold text-heading mb-4">技术栈</h2>
        ...
        <div className="mt-8 text-center">
          <div className="flex items-center justify-center gap-4">
            <a href="#" className="glass-btn rounded-lg p-2 hover:scale-105 transition-transform">
              <GitBranch className="w-5 h-5 text-body" />
            </a>
          </div>
