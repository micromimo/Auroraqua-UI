  ...
  return (
    <div className="h-full flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-slate-700">Mermaid Flowchart&Diagrams</h2>
        <div className="flex items-center gap-3">
          <div className="text-xs text-slate-500">缩放: {Math.round(scale * 100)}%</div>
          <button
            onClick={handleExportPDF}
            className="glass-button text-sm flex items-center gap-2 text-slate-600 hover:text-pink-700"
          >
              ...
              <div className="flex flex-col gap-4 h-[calc(80vh-100px)]">
                <div className="flex-1">
                  ...
                  <textarea
                    ...
                    className="w-full h-full min-h-[300px] p-4 bg-white/30 rounded-xl border border-white/40 text-sm font-mono text-slate-700 resize-none focus:outline-none focus:border-pink-400/50 focus:bg-white/40 transition-all"
